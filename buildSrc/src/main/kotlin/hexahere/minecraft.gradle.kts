...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexahere.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexahere-common-common-refmap.json
        // fixed:   hexahere-common.refmap.json
