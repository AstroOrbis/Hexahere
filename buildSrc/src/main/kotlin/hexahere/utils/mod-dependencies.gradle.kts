...
abstract class HexahereModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexahereModDependenciesExtension>("hexahereModDependencies")
