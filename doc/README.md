...
Python web book docgen and [hexdoc](https://pypi.org/project/hexdoc) plugin for Hexahere.

small utils for hexcasting
...
```sh
GITHUB_REPOSITORY=AstroOrbis/Hexahere
GITHUB_SHA=main
GITHUB_PAGES_URL=https://astroorbis.github.io/Hexahere
```
