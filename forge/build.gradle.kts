...
loom {
    forge {
        ...
        mixinConfig(
            "hexahere-common.mixins.json",
            "hexahere-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hexahere.apply-datagen-mixin", "true")
                property("hexahere.$platform-datagen", "true")
            }
        }
    }
}

hexahereModDependencies {
